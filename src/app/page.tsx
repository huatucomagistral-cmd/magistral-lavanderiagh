  ...
  export default function LandingPage() {
    return (
      <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
        ...
        {/* Navbar */}
        <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-lg border-b border-black/5">
      ...
      {/* Features Showcase */}
      <section className="py-20 bg-black/5 backdrop-blur-xl border-y border-black/5 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 underline-offset-4 decoration-primary">
             <h2 className="text-3xl font-bold mb-4 text-foreground">Todo lo que necesitas en un solo lugar</h2>
             <p className="text-foreground/50 max-w-xl mx-auto">Diseñado específicamente para las necesidades logísticas y administrativas del rubro de lavanderías modernas.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="glass-card p-8 group hover:bg-black/[0.03] transition-colors border-black/10">
              ...
              <p className="text-foreground/70 leading-relaxed">Tu negocio, tus reglas. Toda tu información, pedidos y las finanzas de tus locales están 100% protegidas en tu propio espacio privado.</p>
            </div>
            ...
            <div className="glass-card p-8 group hover:bg-black/[0.03] transition-colors border-black/10">
              ...
              <p className="text-foreground/70 leading-relaxed">Actualización instantánea. Los estados de pedido que cambies en el administrador se reflejan al instante en la vista del cliente.</p>
            </div>
            ...
            <div className="glass-card p-8 group hover:bg-black/[0.03] transition-colors border-black/10">
              ...
              <p className="text-foreground/70 leading-relaxed">Aperturas y cierres de caja con historial. Gestiona múltiples trabajadores con permisos limitados y auditoría clara.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 bg-background border-t border-black/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            />
            <span className="font-bold text-sm text-foreground/50">© 2026 Magistral SaaS. Todos los derechos reservados.</span>
          </div>
